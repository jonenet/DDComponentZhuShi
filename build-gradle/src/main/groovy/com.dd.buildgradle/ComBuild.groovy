...
//        taskNames is [:app:assembleDebug]
...
//        current module is app
        ...
        //执行任务   assembleRelease    ComExtension 是  combuild 传入的闭包
        //只要有任务就会进入
        if (assembleTask.isAssemble) {
            fetchMainModulename(project, assembleTask)
//            compilemodule  is app
        ...
        println "module = " + module + "isRunAlone = " + isRunAlone
